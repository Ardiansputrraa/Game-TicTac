...
public class TicTacPlayer implements InterfaceControl {
    ...
    public TicTacPlayer() {
        ...
        pemainB.setText(pemain.getPlayerB());
        music();
        runGame();
        resetGame();
        cekGame();
                ...
                getBtnMain()[i][j].addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                            ...
                            for (int b = 0; b < 3; b++) {
                                if (e.getSource() == getBtnMain()[a][b]) {
                                    if (giliran % 2 == 0) {
                                        ...
                                        getBtnMain()[a][b].setText("X");
                                        getBtnMain()[a][b].setForeground(Color.RED);
                                        getBtnMain()[a][b].setEnabled(false);
                                        getPemainJP()[a][b].setVisible(true);
                                        getPemainJL()[a][b].setText("X");
                                        getPemainJL()[a][b].setForeground(Color.RED);
                                    }
                                }
                            }
                        }
                        ...
                        if (giliran % 2 == 0) {
                            ...
                            getPemainA().setForeground(Color.WHITE);
                            getPemainB().setForeground(Color.RED);
                        }
                    }
                });
            }
    ...
    public void cekGame() {
        ...
        for (int a = 0; a < 8; a++) {
            if (hasil[a].equals("XXX") || hasil[a].equals("OOO")) {
                if (hasil[a].equalsIgnoreCase("OOO")) {
                    JOptionPane.showMessageDialog(null, "Pemenangnya adalah " + pemain.getPlayerA());
                } else if (hasil[a].equalsIgnoreCase("XXX")) {
                    JOptionPane.showMessageDialog(null, "Pemenangnya adalah " + pemain.getPlayerB());
                }
                for (int i = 0; i < getBtnMain()[0].length; i++) {
                    for (int j = 0; j < getBtnMain()[0].length; j++) {
                        getBtnMain()[i][j].setText("");
